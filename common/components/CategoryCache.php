...
//            $this->cache->cachePath = Yii::getAlias('@app/../common/cache');
//
//            if($this->cache->get($this->cacheKey.'Hot')) $this->cache->delete($this->cacheKey.'Hot');
//            if($this->cache->get($this->cacheKey.'Tree')) $this->cache->delete($this->cacheKey.'Tree');
//            if($this->cache->get($this->cacheKey.'TreeArr')) $this->cache->delete($this->cacheKey.'TreeArr');
//            if($this->cache->get($this->cacheKey.'KV')) $this->cache->delete($this->cacheKey.'KV');
//            if($this->cache->get($this->cacheKey.'List')) $this->cache->delete($this->cacheKey.'List');
//            if($this->cache->get($this->cacheKey.'HotTreeArr')) $this->cache->delete($this->cacheKey.'HotTreeArr');
//        }
//    }
//
